      ...
      _mouseStop: function (e) {
        ...
        return (
          this._helper &&
            ...
            (r =
              parseFloat(c.element.css('left')) + (c.position.left - c.originalPosition.left) ||
              null),
            (h =
              parseFloat(c.element.css('top')) + (c.position.top - c.originalPosition.top) || null),
    ...
    t.ui.plugin.add('resizable', 'containment', {
      ...
      resize: function (e) {
        ...
        d[0] !== document && /static/.test(d.css('position')) && (u = h),
          ...
          (i = Math.abs(
            a.sizeDiff.width + (a._helper ? a.offset.left - u.left : a.offset.left - h.left)
          )),
          (s = Math.abs(
    ...
    parseDate: function (e, i, s) {
      ...
      if (
        (-1 === g
          ...
          : 100 > g &&
            (g +=
              new Date().getFullYear() - (new Date().getFullYear() % 100) + (c >= g ? 0 : -100)),
        v > -1)
      )
        for (m = 1, _ = v; ; ) {
