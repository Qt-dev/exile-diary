class MapTable {
  ...
  static COLUMNS = {
    date: {
      label: 'Date',
      f: (map) => moment(map.id, 'YYYYMMDDHHmmss').format('YYYY-MM-DD HH:mm:ss'),
    },
    ...
    xpRate: {
      label: 'XP/hr',
      f: (map) => Utils.getXPRate(map.xpgained, map.firstevent, map.lastevent),
    },
    c: {
      label: "<img class='currencyText' src='res/img/c.png'>",
      f: (map) => Number(map.gained).toFixed(2),
    },
    cRate: {
