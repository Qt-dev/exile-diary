...
export const NEW_TEST_DATASETS = {
  small1: [
    ...
    },
    {
      ...
      corrupted:
        'Vaal Vessel contains an additional Corrupted Rare Item with an Incursion Modifier',
  ...
  medium2: [
    ...
    },
    {
      ...
      corrupted:
        '12% chance for Maps Tier 14 and above found in Area to drop as Elder Guardian Maps instead',
      expected:
        '12% chance for Maps Tier 14 and above found in Area to drop as Elder Guardian Maps instead',
    },
    {
  ...
  large1: [
    {
      ...
      corrupted:
        '11% less Uniqe Items foun`d from Beyond Demos in your Maps\\nthat are ƒollowers qf Ghorr',
      expected:
        '11% less Unique Items found from Beyond Demons in your Maps\\nthat are followers of Ghorr',
    },
    {
    ...
    },
    {
      ...
      corrupted:
        'Players have 1% reduced Maximum total Life, Mana and Energy Shield Recovery per second from Leech',
      expected:
        'Players have 1% reduced Maximum total Life, Mana and Energy Shield Recovery per second from Leech',
    },
    {
