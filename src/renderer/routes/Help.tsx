    ...
    <div className="Help Box">
      <section>
        ...
        <Typography className="Help__About__Text">
          ...
          <br />
          It is not meant to be a replacement for a trade macro, or a price checker, but rather a tool to help you keep track of your progress and your profits.
        </Typography>
        <Typography className="Help__About__Text">
      ...
      <section>
        <Typography className="Help__About__Text">
          <span className="Text--Legendary">Exile Diary Reborn</span> is <span className="Text--Error">NOT</span> affiliated with or endorsed by{' '}
