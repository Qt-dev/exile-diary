    ...
    <div className="Run">
      ...
      <div className="Run__Header">
        <div className="Run__Header__Left">
          <div className="Run__Header__Name Text--Legendary">
            {run.name}
          </div>
          <div className="Run__Header__Level Text--Legendary">
            Monster level: {run.level} (Tier: {run.tier})
          </div>
          <div className="Run__Header__League Text--Legendary">
            {run.league} League
          </div>
        </div>
        <div className="Run__Header__Block">
          <div className="Run__Header__Block__Title">
            Item Quantity
          </div>
      ...
      <div className="Run__XP">
        XP: <span className='Text--Rare'>{run.initialxp?.toLocaleString('en')}</span> <span className={getXpClassname(run.xp)}>{xp}</span> - <span>{run.xpPerHour.toLocaleString('en', {maximumFractionDigits: 0})}/hr</span> 
      </div>
