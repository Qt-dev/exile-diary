  ...
  return (
    <>
      <TableRow sx={isCollapsible ? collapsibleSx : {}}>
        ...
        <TableCell align='center'>{stat.count.toLocaleString('en-US', {maximumFractionDigits: 0})}</TableCell>
        <TableCell align='center'>{stat.count === 0 ? '--' : moment.utc(stat.totalTime * 1000).format('HH:mm:ss')}</TableCell>
        <TableCell align='center'>{stat.count === 0 ? '--' : moment.utc(stat.fastest * 1000).format('HH:mm:ss')}</TableCell>
