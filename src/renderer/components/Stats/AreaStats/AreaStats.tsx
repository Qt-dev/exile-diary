  ...
  return (
    <>
      <TableRow sx={{ '& > *': { borderBottom: 'none' } }}>
        ...
        <TableCell sx={{width: 100}} align="center">{stats.count}</TableCell>
        <TableCell sx={{width: 100}} align="center">{moment.utc(stats.time * 1000).format('HH:mm:ss')}</TableCell>
        <TableCell sx={{width: 100}} align="right">{stats.gained.toLocaleString()}</TableCell>
        <TableCell sx={{width: 100}} align="right">{stats.profitPerHour.toLocaleString()}</TableCell>
        <TableCell sx={{width: 100}} align="right">{stats.kills.toLocaleString()}</TableCell>
        <TableCell sx={{width: 100}} align="right">{stats.deaths.toLocaleString()}</TableCell>
      </TableRow>
      <TableRow>
      ...
      <Table size="small" sx={{marginTop: '5px', marginBottom: '15px'}}>
        <TableHead>
          <TableRow className='Area-Stats__Header'>
            ...
            <TableCell variant="head" align="center"><TableSortLabel hideSortIcon active={orderBy === 'count'} direction={orderBy === 'count' ? order : 'desc'} onClick={sort('count', order)}>Count</TableSortLabel></TableCell>
