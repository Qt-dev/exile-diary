    ...
    <div className="Run-List Box">
        ...
        <Table size='small' align='center'>
          <TableHead>
            <TableRow>
              ...
              <TableCell align='center'><img className='Run-List__List__Header__Icon' src={ChaosIcon} alt='profit'/></TableCell>
          ...
          <TableBody>
            {store.sortedRuns.map((run, i) => {
              ...
              return (<TableRow
                  ...
                  <TableCell align='center'>{run.level}{run.tier !== null ? ` (T${run.tier})` : '-'}</TableCell>
      ...
      <div className='Run-List__Footer'>
        ...
        <Select 
          ...
          <MenuItem className='Map_Filter-Selector__Item' value={100}>100</MenuItem>
        </Select>
      </div>
    </div>
  );
